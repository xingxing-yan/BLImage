...
//        }
        ...
        canvas.drawColor(-1);
        Bitmap target = Bitmap.createBitmap(this.getWidth(), this.getHeight(), this.backgroundBitmap.getConfig());
        canvas.drawBitmap(this.backgroundBitmap, null, new Rect(0, 0, target.getWidth(), target.getHeight()), null);
        canvas.drawBitmap(this.paintBitmap, 0.0F, 0.0F, null);
...
//		paintCanvas = new Canvas(paintBitmap);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.mRatio != 0.0F) {
            ...
            this.paintBitmap = Bitmap.createBitmap(newWidth, newHeight, Bitmap.Config.ARGB_8888);
